...
if __name__ == '__main__':
    ...
    t = torch.nn.functional.interpolate(t, (448, 448), mode='bilinear', align_corners=False)
    # print(t.shape)
    ...
    heatmaps = torch.nn.functional.interpolate(heatmaps, scale_factor=8, mode='bilinear', align_corners=False).squeeze(0)
    paf_maps = torch.nn.functional.interpolate(paf_maps, scale_factor=8, mode='bilinear', align_corners=False).squeeze(0)
